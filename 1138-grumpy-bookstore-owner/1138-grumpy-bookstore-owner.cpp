...
3. if grumpy[i] == 0, then add county by customers[i]
4. after that we try to use the secret technique
5. loop from the first index of the array until the last index of the array
